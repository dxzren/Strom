Shader "Custom/MyShaderSelectChar" {
	Properties {
		_MainTex ("Base (RGB)", 2D) = "white" {}
		_BumpMap("Bumpmap", 2D) = "bump" {} 

		_AmbientColor ("Ambient Color", Color) = (0.1, 0.1, 0.1, 1.0)  
		_SpecularColor ("Specular Color", Color) = (0.3, 0.36, 0.4, 1.0)  
		_Glossiness ("Gloss", Range(1.0,512.0)) = 30

		_RimColor ("Rim Color", Color) = (0.22,0.41, 0.79, 1.0)  
